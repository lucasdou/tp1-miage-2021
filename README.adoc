...
il faudra donc ajouter @Inject au dessus du contructeur.
...
s�parer les �l�ments en deux parties int�rieur (use-cases,ports et entit�s) et ext�rieur (Adapteurs etc)
...
Si le ou les r�sultats renvoy�s sont conformes � ce que le client voudrait.
